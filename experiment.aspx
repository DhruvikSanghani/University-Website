<%@ Page Title="" Language="C#" MasterPageFile="~/dashboard_master.Master" AutoEventWireup="true" CodeBehind="experiment.aspx.cs" Inherits="first_project.experiment" %>
                        ...
                        <div class="panel-body">
                            ...
                            <asp:Repeater ID="Repeater1" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <asp:Label ID="Name" runat="server" Text='<%# Eval("sname") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Aadhaar No.:
                                    ...
                                    <td>
                                        <asp:Label ID="Aadhar" runat="server" Text='<%# Eval("aadhar") %>'></asp:Label>
                                    </td>
                                     <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="ParMobile" runat="server" Text=""></asp:Label>
